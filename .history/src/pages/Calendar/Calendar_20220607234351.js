        ...
        <div className="container-bg-calendar">
          ...
          <div className="book-calendar">
            <div className="book-calendar-content">
              <p>Bạn đang gặp các vấn đề về da mặt, mụn, tóc,... Hãy đến ngay với chúng tôi bằng cách đặt lịch online, bạn sẽ tiết kiệm được rất nhiều thời gian hoặc bạn có thể gọi điện cho Spa Kim Bông qua số điện thoại: 1900 0000</p>
            </div>
